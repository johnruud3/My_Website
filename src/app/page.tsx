        ...
        <main className="w-full">
          <div className="flex flex-col w-full items-center justify-center min-h-screen relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute h-px w-full bg-gradient-to-r from-transparent via-[#34C1E3] to-transparent opacity-20 animate-[slide_8s_linear_infinite] top-1/4"></div>
              <div className="absolute h-px w-full bg-gradient-to-r from-transparent via-[#146C82] to-transparent opacity-20 animate-[slide_10s_linear_infinite] top-1/2"></div>
              <div className="absolute h-px w-full bg-gradient-to-r from-transparent via-[#34C1E3] to-transparent opacity-20 animate-[slide_12s_linear_infinite] top-3/4"></div>
            </div>

            {/* Content */}
            <div className="relative z-10 flex flex-col items-center mb-36">
              <p className="text-white text-[4.25rem] font-semibold">
                Welcome!
              </p>
              <p className="text-white text-1xl font-semibold -mt-5">
                I am John a web{" "}
                <span className="text-[#34C1E3]">developer</span> and{" "}
                <span className="text-[#34C1E3]">designer</span>
              </p>

              {/* Tech stack logos */}
              <div className="flex gap-5 mt-5 items-center opacity-60">
                {/* Next.js */}
                <svg
                  className="w-8 h-8 text-white opacity-70 hover:opacity-100 transition-opacity"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                ...
                {/* React */}
                <svg
                  className="w-8 h-8 text-[#34C1E3] opacity-70 hover:opacity-100 transition-opacity"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
